...
Player_sprite = pygame.image.load("Player.jpg").convert_alpha()
Player_sprite = pygame.transform.scale(Player_sprite, (Player_icon_size, Player_icon_size))
Player2_sprite = pygame.image.load("Player2.jpg").convert_alpha()
...
class Game:
    ...
    def update(self):
        ...
        hits = pygame.sprite.groupcollide(self.player, self.bullets, False, True, collide_hit_box)
        ...
        for hit in hits:
            ...
            if self.player.hp <= 0:
                print("Player 2 wins")
                player.kill()
        hits = pygame.sprite.groupcollide(self.player2, self.bullets, False, True, collide_hit_box)
        for hit in hits:
